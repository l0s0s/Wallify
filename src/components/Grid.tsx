                    ...
                    <div className="relative group">
                        <a href={wallpaper.URL} target="_blank">
                            <img
                                ...
                                src={wallpaper.URL}
                            />
                            <div className="overlay absolute bottom-0 left-0 w-full bg-black bg-opacity-50 text-white py-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 text-center">
